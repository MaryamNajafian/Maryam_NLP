...
"""
    ...
    Output:
        find bigram probabilities using neural networks
        estimate two weight matrices 
        compare them with the bigram probabilities found using counts and logistic regression
        """
...
def main():
    ...
    for epoch in range(epochs):
        ...
        for sentence in sentences:
            ...
            # do a gradient descent step for loss:  W2
            gradient_of_loss_W2 = hidden.T.dot(predictions - targets)
            W2 = W2 - lr * gradient_of_loss_W2

            # do a gradient descent step for loss:  W1
            dhidden = (predictions - targets).dot(W2.T) * (1 - hidden * hidden)
            gradient_of_loss_W1 = inputs.T.dot(dhidden)
            W1 = W1 - lr * gradient_of_loss_W1
    ...
    # plot the weights W (instead of actual probabilities) and bigram probs side-by-side
